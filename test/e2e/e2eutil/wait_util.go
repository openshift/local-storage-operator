...
import (
	...
	"github.com/openshift/local-storage-operator/test"
...
func WaitForDeletion(t *testing.T, dynclient client.Client, obj client.Object, retryInterval, timeout time.Duration) error {
