...
func (in *DeviceExclusionSpec) DeepCopyInto(out *DeviceExclusionSpec) {
	*out = *in
	if in.DeviceNameFilter != nil {
		in, out := &in.DeviceNameFilter, &out.DeviceNameFilter
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DeviceExclusionSpec.
func (in *DeviceExclusionSpec) DeepCopy() *DeviceExclusionSpec {
	if in == nil {
		return nil
	}
	out := new(DeviceExclusionSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *LocalVolumeSetSpec) DeepCopyInto(out *LocalVolumeSetSpec) {
	*out = *in
	...
	if in.DeviceExclusionSpec != nil {
		in, out := &in.DeviceExclusionSpec, &out.DeviceExclusionSpec
		*out = new(DeviceExclusionSpec)
		(*in).DeepCopyInto(*out)
	}
}
